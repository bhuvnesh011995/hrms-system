...
module.exports = function(app){
    ...
    app.get("/rt/api/v1/subdepartment/:id",[middleware.validateId],subdepartmentController.getAllSubdepartment) // passing department id to get all its subdepartment
