...
module.exports = function(app){
    app.post("/rt/api/v1/subdepartment/",[middleware.customFieldValidateId("department"),middleware.verifyToken],subdepartmentController.addSubdepartment)
    ...
    app.get("/rt/api/v1/subdepartment/:id",[],subdepartmentController.getSubDepartmentByDepartmentId)
}