...
export default function Riligion({ data, getAll, setIsError }) {
    ...
    () => [
      {
        ...
        header: "Riligion",
        Header: () => (
          <FormattedMessage id='Riligion' defaultMessage={"Riligion"} />
        ),
      },
    ],
    [],
              ...
              <Box sx={{ display: "flex", flexWrap: "nowrap", gap: "8px" }}>
                ...
                {(permissions.includes("All") ||
                  ...
                  <IconButton
                    color='error'
                    onClick={() => {
                      handleDelete("religion", row.original.id);
                    }}
                  >
                    <DeleteIcon />
                  </IconButton>
