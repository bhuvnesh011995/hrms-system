...
export default function Security({ data, getAll, setIsError }) {
    ...
    () => [
      {
        ...
        header: "Company Type",
        Header: () => (
          <FormattedMessage id='Company_Type' defaultMessage={"Company Type"} />
        ),
      },
    ],
    [],
              ...
              <Box sx={{ display: "flex", flexWrap: "nowrap", gap: "8px" }}>
                ...
                {(permissions.includes("All") ||
                  ...
                  <IconButton
                    color='error'
                    onClick={() => {
                      handleDelete("security", row.original.id);
                    }}
                  >
                    <DeleteIcon />
                  </IconButton>
