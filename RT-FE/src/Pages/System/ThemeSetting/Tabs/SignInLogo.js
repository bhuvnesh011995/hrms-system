...
export default function SignInLogo({getThemeSettingData,data}) {
...
for( let key in dataToUpdate){
  ...
  let res = await updateThemeSetting("signInPageLogo",formData)
  ...
  if(res.status ===204){
    ...
    return(
        ...
        <form action="">
            ...
            type="button" class="btn btn-primary waves-effect waves-light w-25">SAVE</button>
        </form>
