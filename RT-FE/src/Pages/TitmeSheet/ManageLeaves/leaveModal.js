                  ...
                  >
                    ...
                    <option value="">Select Employee</option>
                    {
                      allEmployees?.length && allEmployees.map(employee => (
                        <option value={employee._id} selected={watch("employeeId") == employee._id && employee._id}>{employee.username}</option>
                      ))
                    }
                  </select>
                                                                {errors?.employeeId && (
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control select2-templating " {...register("title",{required:"Please Select Leave Type"})} style={{width: "100%"}}>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                               ...
                                                               <input type="text" class="form-control" {...register("remarks",{required:"Please Enter Remarks"})} placeholder=""/>
                                                               {errors?.remarks && (
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                               ...
                                                               <input type="date" class="form-control" {...register("startDate",{required:"Please Select Start Date"})} placeholder=""/>
                                                               {errors?.startDate && (
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                               ...
                                                               <input type="date" class="form-control" {...register("endDate",{required:"Please Select End Date"})} placeholder=""/>
                                                               {errors?.endDate && (
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <input type="checkbox" {...register("halfDay")} class="" placeholder=""/>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                               ...
                                                               <input type="file" class="form-control" {...register("files")} placeholder=""/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <label for="" class="form-label">Leave Reason</label> <br/>
                                                               <textarea name="" id="" cols="30" rows="10" style={{height: "70px"}} {...register("leaveReason",{required:"Please Enter Leave Reason"})} class="form-control"></textarea>
                                                               {errors?.leaveReason && (
                                                                  <span className="text-danger">{errors?.leaveReason.message}</span>
                                                                )}
                                                            </div>
                                                        </div>
                                                    </div>
