...
export default function EmployeeTable() {
  ...
  const columns = useMemo(
    () => [
      {
        accessorFn: (row) =>
          row.from ? row.from.fName + " " + row.from.lName : "not available",
        id: "from",
        Header: () => (
          <FormattedMessage
            id='From_Employee'
            defaultMessage={"From Employee"}
          />
        ),
...

      {
        accessorFn: (row) =>
          row.against
            ? row.against.fName + " " + row.against.lName
            : "not available",
        id: "against",
        Header: () => (
          <FormattedMessage
      ...
      },
      {
        ...
        Header: () => (
          <FormattedMessage
            id='Complaint_Title'
            defaultMessage={"Complaint Title"}
          />
        ),
