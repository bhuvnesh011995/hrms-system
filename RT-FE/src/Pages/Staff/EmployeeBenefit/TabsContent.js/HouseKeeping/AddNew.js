...
import { addHousingKeeping } from "../../../../../Utility/API/housingKeeping";
...
export default function AddNew({show,setShow}) {
    ...
    const addRow = () => {
      ...
      const submitData = async (data) => {
        try {
          let res = await addHousingKeeping(data);
  ...
  <div className="d-flex justify-content-end">
      ...
      <i className="fa fa-plus"></i> Add Row
          ...
          {rows.map((row,index) => (
                        <div key={index}  className="row">
                                                                ...
                                                                <div className="col-md-4">
                                                                    <div className="mb-3">
                                                                        <label for="formrow-firstname-input" className="form-label">Housekeeping Service</label> <br/>
                                                                        <select className="form-control select2-templating " style={{width: "100%"}}{...register(`rows.${index}.houseKeeping`)}  >
                                                                            <option value="servent">servent</option>
                                                                            <option value="Gandener">Gandener</option>
                                                                            <option value="UpKepping of Compound">UpKepping of Compound </option>
    ...
    <div className="col-md-3">
      <div className="mb-3">
        <label htmlFor="">Annual Wage </label>
        <input type="text" className="form-control" placeholder="" {...register(`rows.${index}.annualWage`)} />
      </div>
    </div>
